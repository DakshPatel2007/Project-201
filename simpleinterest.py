...
app_label=Label(window, text="SIMPLE INTEREST CALCULATOR", fg = "black", bg = "lightblue", font=("Calibri", 20),bd=5)
app_label.place(x=20, y=20)

principle_label=Label(window, text="Principle in ₹", fg = "black", bg = "lightblue", font=("Calibri", 12),bd=1)
...
time_label=Label(window, text="Time in Years", fg = "black", bg = "lightblue", font=("Calibri", 12))
...
result=Label(result_frame,text="Your result will be displayed here", bg = "white", font=("Calibri", 12), width=55, height=2)
